    ...
    if uploaded_file is not None:
        ...
        with tab1:
            ...
            with col1:
                ...
                st.image(ela_results[ela_quality], caption=f"ELA at {ela_quality}", use_column_width=True)
                ...
                st.image(edge_results[edge_method], caption=f"{edge_method.capitalize()} Edge Detection", use_column_width=True)
            ...
            with col2:
                ...
                with st.spinner("Analyzing copy-move patterns..."):
                    ...
                    st.image(copy_move_result, caption="Copy-Move Detection", use_column_width=True)
                ...
                st.image(noise, caption="Noise Residual", use_column_width=True)
        ...
        with tab2:
            ...
            with col2:
                ...
                st.image(jpeg_analysis["dct_analysis"], caption="DCT Coefficient Analysis", use_column_width=True)
                st.image(jpeg_analysis["quantization_noise"], caption="Quantization Noise", use_column_width=True)
        ...
        with tab4:
            ...
            with col1:
                ...
                st.image(pca_normalized, caption="PCA Component Analysis", use_column_width=True)
